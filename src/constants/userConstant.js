...
/*EDIT absence employee*/
export const EDIT_EMPLOYEE_ABSENT_REQUEST = 'EDIT_EMPLOYEE_ABSENT_REQUEST';
export const EDIT_EMPLOYEE_ABSENT_SUCCESS = 'EDIT_EMPLOYEE_ABSENT_SUCCESS';
export const EDIT_EMPLOYEE_ABSENT_FAIL = 'EDIT_EMPLOYEE_ABSENT_FAIL';
