...
export const GET_CUSTOMER_BY_USERNAME_URL = GET_CUSTOMER_LIST_URL + FORWARD_SLASH;

//Employee
export const GET_EMPLOYEE_LIST_URL = BASE_URL + ADMIN + EMPLOYEE;

export const GET_EMPLOYEE_BY_USERNAME_URL = GET_EMPLOYEE_LIST_URL + FORWARD_SLASH;

export const POST_NEW_EMPLOYEE = GET_EMPLOYEE_LIST_URL;

//Manufacturer
export const GET_MANUFACTURER_LIST_URL = BASE_URL + ADMIN + MANUFACTURER;

export const GET_MANUFACTURER_BY_NAME_URL = GET_MANUFACTURER_LIST_URL + FORWARD_SLASH;

export const POST_NEW_MANUFACTURER = GET_MANUFACTURER_LIST_URL + INSERT_MANUFACTURER;

export const POST_NEW_MANUFACTURER_WITH_MODELS = GET_MANUFACTURER_LIST_URL + INSERT_MANUFACTURER;
//Offer
